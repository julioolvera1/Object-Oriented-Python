...
class Square:
    ...
    def __init__(self,side_length):
        ...
        ## also, this avoids a conflict with the name of the property below

        
    @property ## This is how you can access the variable as an instance
    def side_length(self):
        return (self._side_length)

    @side_length.setter ## This is how you set a different value
